...
#   CHANGED: shell now owns a single Session (app/session.py) for the whole                                              #
#   process and passes it into every command function, instead of each                                                   #
#   command re-reading/writing a JSON file on disk. See session.py's                                                     #
#   docstring for why.                                                                                                    #
# ----------------------------------------------------------------------------------------------------------------------- #
...
# ----------------------------------------------------------------------------------------------------------------------- #
#                   parses a command and dispatches it, always passing self.session through                               #
# ----------------------------------------------------------------------------------------------------------------------- #
...
# ----------------------------------------------------------------------------------------------------------------------- #
#           This is what starts our shell; unchanged except session lives on self now.                                    #
# ----------------------------------------------------------------------------------------------------------------------- #
    def run(self):
        print("Welcome to the Scheduler Management Shell!")
        print("Type 'help' to see available commands. Type 'exit' to leave the shell.\n")
        while True:

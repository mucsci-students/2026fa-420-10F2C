...
# Parses a raw command string and dispatches it (unchanged).
    ...
    _ENTITY_HELP = {
        "Faculty":
            ...
            "  2. Modify Faculty   Looked up by name -- you re-enter every\n"
        ...
        "Room":
            ...
            "  2. Modify Room       Looked up by name -- re-enter every\n"
            "                       field.\n"
        ...
        "Lab":
            ...
            "  2. Modify Lab        Looked up by name -- re-enter every\n"
            "                       field.\n"
        ...
        "Class Pattern":
            ...
            "                          more meetings.\n"
            "  2. Modify Class Pattern  Pick an index, then re-enter the\n"
            "                          whole pattern.\n"
